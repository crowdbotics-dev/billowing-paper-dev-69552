...
## Project Structure
    ...
    ├── billowing_paper_dev_69552  # Django project configurations
...
1. Clone this repo and `cd billowing_paper_dev_69552`
...
2. Clone this repo and `cd billowing_paper_dev_69552`
